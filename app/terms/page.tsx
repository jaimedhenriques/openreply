...
export const metadata: Metadata = {
  title: "Terms of Service - CommentShift",
  description:
    "Terms for using CommentShift's Instagram comment-to-DM campaign software.",
};
...
export default function TermsPage() {
  return (
    <LegalShell
      ...
      description="These terms define acceptable use for CommentShift's hosted Instagram comment-to-DM campaign service."
      updatedAt="May 24, 2026"
    >
      <section>
        <h2 className="text-xl font-bold">Authorized use</h2>
        <p className="mt-3">
          You may use CommentShift only with Instagram professional accounts you
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          CommentShift may rate-limit, pause, or disable campaigns that create
      ...
      <section>
        ...
        <p className="mt-3">
          CommentShift depends on third-party platforms including Meta, email,
