...
export const metadata: Metadata = {
  title: "Meta App Review Support - CommentShift",
  description:
    "Meta App Review notes for CommentShift's official Instagram private reply workflow.",
};
...
export default function MetaReviewPage() {
  return (
    <LegalShell
      ...
      description="CommentShift is designed for Instagram professional accounts that want to send private replies after keyword comments on their own posts or reels."
      updatedAt="May 24, 2026"
    >
      <section>
        <h2 className="text-xl font-bold">User flow</h2>
        <p className="mt-3">
          ...
          reel, and receives a webhook when someone comments. CommentShift queues
