...
export const metadata: Metadata = {
  title: "Data Deletion - CommentShift",
  description:
    "How CommentShift customers can disconnect Instagram and request account or campaign data deletion.",
};
...
export default function DataDeletionPage() {
  return (
    <LegalShell
      title="Data Deletion"
      description="Use this page for Meta App Review and customer requests about removing CommentShift account, workspace, Instagram, and campaign data."
      updatedAt="May 24, 2026"
    >
      <section>
        <h2 className="text-xl font-bold">Disconnect Instagram</h2>
        <p className="mt-3">
      ...
      <section>
        <h2 className="text-xl font-bold">Delete workspace data</h2>
        <p className="mt-3">
