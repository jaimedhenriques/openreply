      ...
      <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-3">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button
            ...
            disabled={saving}
            className="pressable min-h-11 rounded-lg bg-accent px-5 py-2 text-sm font-medium text-accent-foreground hover:bg-accent-hover disabled:opacity-50"
          >
            ...
            {requireFollow && (
              <div className="mt-3 space-y-2">
                <textarea
                  ...
                  placeholder="quick favor before i send your link. tap the button once you're following and i'll send it over"
                  rows={3}
                  className="w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-foreground placeholder:text-zinc-500 focus:border-accent/40 focus:outline-none resize-none"
                  maxLength={1000}
                />
